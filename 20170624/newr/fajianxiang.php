...
<thead>
      <tr>
        <th height="4" colspan="5" align="left">
          <select name="SearchType" id="SearchType">
            <option value="1">收件会员</option>
          </select>
          <input type="text" name="SearchContent" id="SearchContent">
        <input type="submit" name="Search" id="Search" class="btn" value="搜  索">        <!--<input type="button" name="dayin" id="dayin" class="btn1" value="导出表格" onClick="exportExcel('daochu')">
      ...
      <tr>
        ...
        <td align="center"><input name="" type="button" class="btn" value="查  看" onClick="window.location.href='mailcontent.php?mid=<?=$row['id']?>'"></td>
      </tr>
      <?php
			}
		}
	  ?>
          ...
          <tr>
            ...
            <td align="right" colspan="4"><?php echo fenye($p,$pagesize,$sum,$total,$cx)?></td>
          </tr>
      </div>
    </table>
</tbody> 
