...
if ($_POST['submit']){
	...
	if($sys['ziliao']==1){
		if($us['password1'] != $_POST['password1']){	//若修改了一级密码
			$_us['password1']=md5($_POST['password1']);
			$_us['zb1']=($_POST['password1']);	//备份一级密码
		}else{
			$_us['password1']=$_POST['password1'];	//不用加密
		}
		
		if($us['password2'] != $_POST['password2']){	//若修改了二级密码
			$_us['password2']=md5($_POST['password2']);
			$_us['zb4']=($_POST['password2']);	//备份二级密码
		}else{
			$_us['password2']=$_POST['password2'];	//不用加密
		}
...
<input name="UserAddress" type="text" id="UserAddress" value="<?=$UserAddress?>" size="30" maxlength="100"></td>
  ...
  <tr >
    <td align="right">一级会员密码：</td>
    <td align="left"><input type="password" name="password1" id="password1" value="<?=$password1?>"></td>
  </tr>
  <tr >
    <td align="right">二级会员密码：</td>
    <td align="left"><input type="password" name="password2" id="password2" value="<?=$password2?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center">
      <table align="center">
        <tr>
          <td><input name="submit" id="submit" type="submit" class="btn" value="修  改">
          <input name="" type="reset" class="btn" value="重  置"></td>
        </tr> 
      </table>
