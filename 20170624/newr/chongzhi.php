...
if ($_POST['submit']){
	...
	if ($jine>0){
		...
		if ($email['cztzadmin']==1){
			$title="会员充值申请";
			$content="管理员您好,会员".$chongzhi['nickname']."于".now()."向公司申请充值：".$jine."元报单币";
...
<table  width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
  <tr>
    <td width="46%" height="22" align="right">充值类型：</td>
  ...
  <tr>
    <td height="22" align="right">充值金额：</td>
...
<table align="center" class="ziti">
        <tr>
          <td><input name="submit" id="submit" type="submit" class="button_green" value="充  值"></td>
        </tr>
      </table>
<br>
