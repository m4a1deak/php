...
if ($_GET['action']=="admin"){
	...
	//A区
	if ($p1=getFatherManbyFidAndTreeplace2($ID,1)){
	...
	//AA区
	if ($p11=getFatherManbyFidAndTreeplace2($p1['id'],1)){
	...
	//AB区
	if ($p12=getFatherManbyFidAndTreeplace2($p1['id'],2)){
	...
	//B区
	if ($p2=getFatherManbyFidAndTreeplace2($ID,2)){
	...
	//BA区
	if ($p21=getFatherManbyFidAndTreeplace2($p2['id'],1)){
	...
	//BB区
	if ($p22=getFatherManbyFidAndTreeplace2($p2['id'],2)){
...
<form name="form1" method="post" action="?">
	<tr>
	  <td height="22" colspan="5" class="ziti">查询会员：
	 ...
	 ?>
	  ...
	  <td height="120" colspan="6" align="center"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1" >
	    <tr>
  ...
  <tr>
    <td width="50%" height="103" colspan="2"  align="center"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
    ...
    <td width="50%" colspan="4" align="center"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
        <td style="background:<?=$p2ispaycolor?>" align="center"><?=$p2NickName?></td>
        </tr>
        <tr>
        <td align="center"><?=$p2rname?></td>
      </tr>
      <tr>
  ...
  <tr>
    <td align="center" valign="top"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
        <td style="background:<?=$p11ispaycolor?>" align="center"><?=$p11NickName?></td>
      </tr>
      <tr>
        <td align="center"><?=$p11rname?></td>
      </tr>
      <tr>
        <td align="center"><?=$p11jibie?></td>
      </tr>
    </table></td>
    <td align="center" valign="top"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
        <td style="background:<?=$p12ispaycolor?>" align="center"><?=$p12NickName?></td>
      </tr>
      <tr>
        <td align="center"><?=$p12rname?></td>
      </tr>
      <tr>
        <td align="center"><?=$p12jibie?></td>
      </tr>
    </table></td>
    <td align="center" valign="top"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
        <td style="background:<?=$p21ispaycolor?>" align="center"><?=$p21NickName?></td>
      </tr>
      <tr>
        <td align="center"><?=$p21rname?></td>
      </tr>
      <tr>
        <td align="center"><?=$p21jibie?></td>
      </tr>
    </table></td>
    <td colspan="3" align="center" valign="top"><table height="103" width="120" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
        <td style="background:<?=$p22ispaycolor?>" align="center"><?=$p22NickName?></td>
      </tr>
      <tr>
        <td align="center"><?=$p22rname?></td>
      </tr>
      <tr>
        <td align="center"><?=$p22jibie?></td>
      </tr>
    </table></td>
  </tr>
</table>
