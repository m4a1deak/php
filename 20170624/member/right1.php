...
switch ($h){
  ...
  <tr style="display:none">
   ...
   <tr>
 	 <td align="center" style="background:blue;color:yellow;font-size: 20px">会员登录信息</td>
 	 
    <td align="center" style="background:blue;color:yellow;font-size: 20px">升级付费信息</td>
  </tr>
  <tr>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
<tr >
	<th align="center" style="background:blue;color:yellow;font-size: 20px" colspan="2">你的团队信息</th>
</tr>
<tr>
 	<td align="center" style="background:red;color:white;font-size: 20px">层数</td>
    <td align="center" style="background:red;color:white;font-size: 20px">数量</td>
  </tr>
  <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel=$plevel+1 ";
  ...
  <tr>
   ...
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel=$plevel+2 ";
  	$query=mysql_query($sql);
  ...
  <tr>
   ...
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel=$plevel+3 ";
  	$query=mysql_query($sql);
  ...
  <tr>
   ...
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel=$plevel+4 ";
  	$query=mysql_query($sql);
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
<tr >
	<th align="center" style="background:blue;color:yellow;font-size: 20px" colspan="3">团队付费情况</th>
</tr>
<tr>
 	<td align="center" style="background:red;color:white;font-size: 20px">等级</td>
 	 
    <td align="center" style="background:red;color:white;font-size: 20px">付费总额</td>
    <td align="center" style="background:red;color:white;font-size: 20px">付费情况</td>
  </tr>
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel<=$plevel+4 and plevel>$plevel and ulevel=1 and ispay=1";
  	$query=mysql_query($sql);
  	$numa=mysql_num_rows($query);
  ?>
  <tr>
 	<td align="center">1</td>
 	 <td align="center"><?=$us['x1']*1000?></td>
    <td align="center"><?=$us['x1']?>/3</td>
  </tr>
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel<=$plevel+4 and plevel>$plevel and ulevel=2 and ispay=1";
  	$query=mysql_query($sql);
  	$numb=mysql_num_rows($query);
  ?>
  <tr>
 	<td align="center">2</td>
 	 <td align="center"><?=$us['x2']*2000?></td>
    <td align="center"><?=$us['x2']?>/9</td>
  </tr>
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel<=$plevel+4 and plevel>$plevel and ulevel=3 and ispay=1 ";
  	$query=mysql_query($sql);
  	$numc=mysql_num_rows($query);
  ?>
  <tr>
 	<td align="center">3</td>
 	 <td align="center"><?=$us['x3']*8000?></td>
    <td align="center"><?=$us['x3']?>/27</td>
  </tr>
   <?php 
	$plevel=$us['plevel'];  
  	$sql="select * from member where plevel<=$plevel+4 and plevel>$plevel and ulevel=4 and ispay=1";
  	$query=mysql_query($sql);
  	$numd=mysql_num_rows($query);
  ?>
  <tr>
 	<td align="center">4</td>
 	 <td align="center"><?=$us['x4']*30000?></td>
