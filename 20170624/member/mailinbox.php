...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <tr>
        ...
        <td align="center"><input name="" type="button" class="button_green" value="查  看" onClick="window.location.href='mailcontent.php?mid=<?=$row['id']?>&hf=1'"></td>
      </tr>
      <?php
			}
		}
