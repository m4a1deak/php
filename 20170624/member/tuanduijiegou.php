        ...
        <div class="widget">
          ...
          <div class="widget-content2">
            <dl class="dl-horizontal">
			  ...
			  <?php 
				$sql="select * from member where ppath like '%{$benren['ppath']}%'";
...
<form name="form1" method="post" action="?">
	...
	<tr>
    <td height="36" colspan="6" align="center"><img src="../member/images/t_tree_bottom_l.gif"  height="30" style="height:30px;"><img src="../member/images/t_tree_line.gif" alt=""  width="280" height="30" style="height:30px;"><img src="../member/images/t_tree_top.gif"  height="30" style="height:30px;"><img src="../member/images/t_tree_line.gif" alt=""  width="280" height="30" style="height:30px;"><img src="../member/images/t_tree_bottom_r.gif" height="30" style="height:30px;"></td>
  </tr>
  <tr>
