...
<tr>
  ...
  <tr >
    <td height="22" align="right">请将准用户：</td>
    <td align="left"><input name="nickname" type="text" value="<?=$us['nickname']?>" id="bankcard" size="20" maxlength="20">激活确认</td>
  </tr>
