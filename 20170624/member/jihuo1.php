...
//							if($me['slevel']==1){
//								$b5=$us['lsk']*0.05;
//								$bonus_cl->dianbu($me['id'],$me['nickname'],$me['bddiqu'],$us['lsk']);
//							}elseif ($me['slevel']==2){
//								$b5=$us['lsk']*0.1;
//							}
//							$me_update['b5']=$me['b5']+$b5;
//							$bonus_cl->bonus_laiyuan($me['id'],$me['nickname'],$us['id'],$us['nickname'],5,$b5,"店补");
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <form name="form1" method="post" action="?id=<?=$row['id']?>">
        ...
        <td align="center"><input name="button3" type="submit" class="button_green" id="button3" value="激  活" onClick="{if(confirm('您确定要激活该会员吗?')){this.document.selform.submit();return true;}return false;}" ></input>      
