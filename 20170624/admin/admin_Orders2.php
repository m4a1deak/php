...
$sql = "SELECT * FROM `orders1` WHERE issend=0 and isqr=1 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."'";
$arr=getall($sql);
$wjine=0;
...
$sql = "SELECT * FROM `orders1` WHERE issend=1 ".$_SESSION['Search']." and sdate>='".$_SESSION['TimeStart']."' and sdate<='".$_SESSION['TimeEnd']."'";
$arr=getall($sql);
$fjine=0;
...
$sql = "SELECT * FROM `orders1` WHERE issend=2 ".$_SESSION['Search']." and sdate>='".$_SESSION['TimeStart']."' and sdate<='".$_SESSION['TimeEnd']."'";
$arr=getall($sql);
$tjine=0;
...
$sql = "SELECT * FROM `orders1` WHERE issend=3 ".$_SESSION['Search']." and sdate>='".$_SESSION['TimeStart']."' and sdate<='".$_SESSION['TimeEnd']."'";
$arr=getall($sql);
$sjine=0;
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <?php
	  	...
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `orders1` WHERE isqr=1 and issend=0 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."'";
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	$sql = "SELECT * FROM `orders1` WHERE isqr=1 and issend=0 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."' order by id desc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <?php
	  	...
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `orders1` WHERE isqr=1 and issend=1 ".$_SESSION['Search']." and sdate>='".$_SESSION['TimeStart']."' and sdate<='".$_SESSION['TimeEnd']."'";
		if($query = mysql_query($sql)){
	  		$sum = mysql_num_rows($query); //计算总记录数 
		}else{
			$sum=0;	
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	$sql = "SELECT * FROM `orders1` WHERE isqr=1 and issend=1 ".$_SESSION['Search']." and sdate>='".$_SESSION['TimeStart']."' and sdate<='".$_SESSION['TimeEnd']."' order by id desc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
		while ($row=mysql_fetch_array($query)){
	  ?>
      <tr>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <?php
	  	...
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `orders1` WHERE issend=2 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."'";
		if($query = mysql_query($sql)){
	  		$sum = mysql_num_rows($query); //计算总记录数 
		}else{
			$sum=0;	
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	$sql = "SELECT * FROM `orders1` WHERE issend=2 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."' order by id desc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
		while ($row=mysql_fetch_array($query)){
	  ?>
      <tr>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <?php
	  	...
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `orders1` WHERE isqr=1 and issend=3 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."'";
		if($query = mysql_query($sql)){
	  		$sum = mysql_num_rows($query); //计算总记录数 
		}else{
			$sum=0;	
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	$sql = "SELECT * FROM `orders1` WHERE isqr=1 and issend=3 ".$_SESSION['Search']." and date>='".$_SESSION['TimeStart']."' and date<='".$_SESSION['TimeEnd']."' order by id desc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
		while ($row=mysql_fetch_array($query)){
	  ?>
      <tr>
