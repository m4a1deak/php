...
<!--        <td align="center"><?=$row['username']?></td>-->
      ...
      <tr>
        ...
        <table width="100%" border="0">
          <tr>
            <td align="left">
<!--            <input name="button" type="submit" class="button_green" class="btn1" id="button" value="确认升级" onClick="{if(confirm('您确定要进行升级确认吗?')){this.document.selform.submit();return true;}return false;}">-->
