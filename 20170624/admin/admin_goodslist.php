...
if ($_POST['Search']){
	...
	if ($SearchContent!=NULL){
		...
		if ($SearchType==1){
			...
			#搜索商品名称
			$_SESSION['Search']="and isdisplay=1";
		}if ($SearchType==4){
			#搜索商品名称
			$_SESSION['Search']="and isdisplay=0";
		}
...
<div class="ziti"> <select name="SearchType" id="SearchType">
        ...
        <input type="button" name="dayin" id="dayin" class="btn1" value="导出" onClick="window.location.href='excel.php?table=orderlist'"></td>
       </div>
...
<!--        <td align="center" ><?=$row['pv']?></td>-->
        <td align="center" ><?php 
        switch($row['lx']){
        	case 1:echo "报单商品";break;
        	case 2:echo "购物商品";break;
