...
//判断是否是一个数组
is_array($all)?$all=$all:$all = array();
...
<?php if ($_SESSION['q17']==1){?>
 ...
 <?php }?>
  ...
  <tr>
    <td align="right">待处理会员升级：</td>
    <td><font color="#0000FF">
      <?=$system['tongzhi']?>
    </font>&nbsp;
    <input type="submit" class="button" id="button3" name="button3" value="现在处理" onClick="window.location.href='admin_ulevelup.php'" /></td>
