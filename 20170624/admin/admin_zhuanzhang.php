...
<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center" class="table1">
      <tr>
        <td height="4"  align="left">
          <select name="SearchType" id="SearchType">
            ...
            <option value="3">复投币</option>
           <!--  <option value="4">奖金</option> -->
          </select>
          <input type="text" name="SearchContent" id="SearchContent">
        <input type="submit" name="Search" id="Search" class="btn1" value="搜索"></td>
        <td height="4" align="center"><input type="button" name="dayin" id="dayin" class="btn1" value="导出表格" onClick="window.location.href='excel.php?table=zhuanzhang'"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="10" colspan="8" align="center"> 转 账 记 录</td>
      </tr>
      <tr>
      ...
      <?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `zhuanzhang` WHERE 1=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']."";
