...
$cheuid_arr = $_POST['UID'];
	...
	foreach ((array)$cheuid_arr as $id)
	{
		...
		if ($ulevelup['issh']==0){
    		...
    		action::record("升级确认", $us['id'],$_SESSION['adminid'],$ulevelup['uplevel']);
    		...
    		//$_member->addArea($us['id'],$ulevelup['cha']);
//     		$_bonus->jicha($us['id'], $ulevelup['cha']);
//     		$_bonus->b2bonus($us['id'], $us['id'], $us['nickname'], $ulevelup['cha']);
//     		$_bonus->dianbu($us['id'],$us['nickname'],$us['bdid'], $ulevelup['cha']);
...
$cheuid_arr = $_POST['UID'];
	foreach ((array)$cheuid_arr as $id)
	{
		...
		if ($ulevelup['issh']==0){
			...
			action::record("升级失败", $us['id'],$_SESSION['adminid'],$ulevelup['uplevel']);
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <div id="daochu">
      <tr >
        <td colspan="7" align="center">复 消 记 录</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="100%" border="0">
          <tr>
            <td align="left">
            <!-- 
            <input name="button" type="submit" class="btn1" id="button" value="确认升级" onClick="{if(confirm('您确定要进行升级确认吗?')){this.document.selform.submit();return true;}return false;}">
