...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      <tr>
        <td height="10" colspan="15" align="left">
      ...
      <tr>
        <td height="5" colspan="15" align="left">搜索时间范围：
      ...
      <tr>
        <td height="10" colspan="15" align="center">正式会员</td>
      </tr>
      <tr>
      ...
      <?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `member` WHERE 1=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']."";
		...
		$xuhao=($p-1)*$pagesize+1;
      	$sql = "SELECT * FROM `member` WHERE 1=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']." ORDER BY id DESC,id asc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
	  ...
	  ?>
      <tr>
        <td height="21" colspan="15" align="right">
