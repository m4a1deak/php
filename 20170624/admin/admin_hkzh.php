...
if ($_POST['save']){
		if($information['hkzh']!=$_POST['content1']){
			action::record("修改汇款账户",$_SESSION['to_admin'],$_SESSION['to_admin'], "修改汇款账户");
		}
		$information['hkzh']=$_POST['content1'];
...
<table width="100%" height="420" border="0">
  <tr>
	...
	内容：
	<br />
    <textarea name="content1" style="width:700px;height:200px;visibility:hidden;"><?=$information['hkzh']?></textarea>
	<br/>
    <!-- <br />
