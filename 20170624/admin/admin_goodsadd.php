  ...
  <tr>
    ...
    <td align="left"><label for="select"></label>
      <select name="lx" id="lx">
        ...
        <option value="2">购物商品</option>
        
<!--         
<option value="1">报单商品</option>
<option value="3">重消商品</option> -->
<!--        <option value="4">二次购物商品</option> -->
      </select></td>
  </tr>
  <tr>
    <td height="22" align="right">商品名称：</td>
    <td align="left"><input name="goodsname" type="text" id="goodsname" size="20" maxlength="50" style="width:400px;"></td>
  </tr>
  <tr>
  ...
  <tr style="display:none;">
    ...
    <td align="left"><input name="price2" type="text" value="0" id="price2" size="20" maxlength="50"></td>
  </tr>
  <tr style="display:none;">
  ...
  <tr>
    ...
    <td align="left"><textarea name="content1" style="width:700px;height:200px;visibility:hidden;">
    </textarea></td>
  </tr>
<tr>
