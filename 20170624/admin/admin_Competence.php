...
<!--        职级会员-->
  ...
  <tr id="qx2" <?=display($zq2)?>>
    <td colspan="2" align="center">
    <!--  
    <input name="q6" type="checkbox" id="q4" value="1" <?=checked($q6)?>>
	晋级奖
	-->
    <input name="q7" type="checkbox" id="q5" value="1" <?=checked($q7)?>>
        福利奖
	...
	会员统计
<!--    <input name="q17" type="checkbox" id="q9" value="1" <?=checked($q17)?>>-->
<!--	爱心基金-->
