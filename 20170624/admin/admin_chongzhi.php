	...
	foreach ((array)$cheuid_arr as $id)
	{
		...
		if ($chongzhi['isgrant']==0){
			...
			if ($chongzhi['lx']==0){
				...
				$us_update['gwb']=$us['gwb']+$chongzhi['jine'];	
			}
			action::record("充值确认", $chongzhi['uid'], $_SESSION['adminid'],"充值确认");
...
<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center" class="table1">
      <tr>
        ...
        <td height="4" align="center"><input type="button" name="dayin" id="dayin" class="btn1" value="导出表格" onClick="window.location.href='excel.php?table=chongzhi'"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="center"><?php if ($row['lx']==0){?>报单币<?php }elseif($row['lx']==1){?>购物币<?php }?></td>
