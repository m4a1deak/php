...
<table  width="90%" height="450" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
	<tr>
    <td height="21" colspan="2" align="center">修 改 商 品<input name="gid" type="hidden" value="<?=$_GET['id']?>"></td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <td align="left" valign="top"><input name="goodsimg" type="text" id="goodsimg" size="20" maxlength="50" value="<?=$goods['goodsimg']?>">
  ...
  <tr >
    ...
    <td align="left"><label for="select"></label>
      <select name="lx" id="lx">
        ...
        <option value="2" <?php if($goods['lx']==2){?> selected<?php }?>>购物商品</option>
       <!--  
        <option value="1" <?php if($goods['lx']==1){?> selected<?php }?>>报单商品</option>
        <option value="3" <?php if($goods['lx']==3){?> selected<?php }?>>重消商品</option> 
        <option value="4" <?php if($goods['lx']==4){?> selected<?php }?>>二次购物商品</option> -->
      </select></td>
  </tr>
  <tr>
    <td height="22" align="right">商品名称：</td>
    <td align="left"><input name="goodsname" type="text" id="goodsname" size="20" maxlength="50" value="<?=$goods['goodsname']?>" style="width:400px;"></td>
  </tr>
  <tr>
    <td height="22" align="right">商品价格：</td>
    <td align="left"><input name="price" type="text" id="price" size="20" maxlength="50" value="<?=$goods['price']?>"></td>
  </tr>
  <tr style="display:none;">
    <td height="22" align="right">重消价格：</td>
    <td align="left"><input name="price2" type="text" id="price2" size="20" maxlength="50" value="<?=$goods['price2']?>"></td>
  </tr style="display:none;">
  <tr style="display:none;">
    <td height="22" align="right">商品PV：</td>
    <td align="left"><input name="pv" type="text" id="pv" value="<?=$goods['pv']?>" size="20" maxlength="50" ></td>
  </tr>
  <tr>
  ...
  <tr >
    <td height="22" align="right">销量：</td>
    <td align="left"><input name="sales" type="text" id="sales" size="20" maxlength="50" value="<?=$goods['sales']?>"></td>
  </tr>
  <tr >
    <td height="22" align="right">显示顺序：</td>
    <td align="left"><input name="shunxu" type="text" id="shunxu" size="20" maxlength="50" value="<?=$goods['shunxu']?>"></td>
  </tr>
  <tr>
    <td height="22" align="right" valign="top">商品信息：</td>
    <td align="left"><textarea name="content1" style="width:700px;height:200px;visibility:hidden;"><?=$goods['goodscontent']?>
    </textarea></td>
  </tr>
<tr>
