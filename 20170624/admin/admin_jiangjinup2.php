...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `member` WHERE ispay>=1 order by area1 desc limit 10";
	  ...
	  ?>
	  <td colspan="12"  align="center"><input type="submit" class="button" id="button" name="button" value="分红结算" style="width:100px" /></td>
      <tr>
