...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <form action="<?php echo U('admin/articel/artupd');?>" method="post">
                <div class="row">
                    栏目名 <input type="text" name="art_name" id="" value="<?php echo ($art['art_name']); ?>">
                </div>
                <div class="row">
                    <script id="container" name="content" type="text/plain">
<div class='cont'><?php echo (htmlspecialchars_decode($art['art_connect'])); ?></div>
                    </script>

                </div>
                <select  name='cat_id'  style="margin-top: 35px">
                    <?php if(is_array($cat)): foreach($cat as $key=>$v): ?><option value="<?php echo ($v['cat_id']); ?>"
                          <?php echo ($v['cat_id']==$art['cat_id']?"selected":""); ?>
