...
<link href="/shopbe/Public/admin/css/general.css" rel="stylesheet" type="text/css" />
<link href="/shopbe/Public/admin/css/main.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="form-div">
  ...
  <form action="" name="searchForm">
    <img src="/shopbe/Public/admin/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/shopbe/Public/admin/images/sort_desc.gif"/>    </th>
...
<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
    ...
    <td align="center"><img src="/shopbe/Public/admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shopbe/Public/admin/images/no.gif"  /></td>
    <td align="center"><img src="/shopbe/Public/admin/images/no.gif"  /></td>
    <td align="center"><img src="/shopbe/Public/admin/images/no.gif"  /></td>
    ...
    <td align="center"><span >100</span></td>
        ...
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/shopbe/Public/admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('admin/goods/goodsedit',array('goods_id'=>$v['goods_id']));?>" title="编辑"><img src="/shopbe/Public/admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/shopbe/Public/admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('admin/goods/goodsdel',array('goods_id'=>$v['goods_id']));?>"  title="回收站"><img src="/shopbe/Public/admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/shopbe/Public/admin/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
