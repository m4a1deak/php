...
<h1>
<span class="action-span"><a href="goodslist.html">商品列表</a></span>
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="<?php echo U('admin/goods/goodsadd');?>" method="post" name="theForm"  >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/shopbe/Public/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            <td class="label"><a href="#" title="点击此处查看提示信息"><img src="/shopbe/Public/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/shopbe/Public/admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
