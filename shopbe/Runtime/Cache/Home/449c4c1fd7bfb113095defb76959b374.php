...
<div class="block1">
  <div class="allMenu fl"> <a href="" title="" style="font-size:15px;" class="index current">首页</a>
    ...
    <?php if(is_array($cattree)): foreach($cattree as $key=>$v): if($v["lv"] == 0): ?><dl>
          ...
          <dd class="clearfix">
            <?php if(is_array($cattree)): foreach($cattree as $key=>$s): if($s['parent_id'] == $v['cat_id']): ?><p><a href="<?php echo U('home/cat/cat',array('cat_id'=>$s['cat_id']));?>" title="CDMA手机" class="txtdot"><?php echo ($s['cat_name']); ?></a></p><?php endif; endforeach; endif; ?>
          </dd>
...
<div id="history_div">
<div class="mod1 mod2 blank" id="historybox">
	<span class="lb">123123111</span><span class="rb">123123222</span>
  <?php if(is_array($lili)): foreach($lili as $key=>$xx): ?><div id="history_list" class="history_list mod2con">
      <a href=""><img src="/shop/<?php echo ($xx['thumb_img']); ?>" alt="" style="width: 50px;height: 50px;"></a><?php echo ($xx['goods_name']); ?>
    ...
    <form name="compareForm" action="" method="post">
        <div class="clearfix grid">
            <?php if(is_array($goodslist)): foreach($goodslist as $key=>$g): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
                <div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$g['goods_id']));?>"><img src="/shop<?php echo ($g['goods_img']); ?>" alt="ECSHOP模板中心68ecs..."></a></div>
