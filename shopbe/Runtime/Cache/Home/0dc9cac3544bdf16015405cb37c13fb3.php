...
<div class="page-header clearfix">
  <div class="block1 clearfix" style="position:relative;">
    <div class="logo fl"><a href="" title=""><img src="Home/images/logo.gif" width="311" height="55" alt=""></a></div>
      <div class="btMap">
        <div class="search ">
...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
		...
		<?php if(is_array($kache)): foreach($kache as $key=>$k): ?><tr>
			...
			<td bgcolor="#ffffff">颜色:黑色 <br></td>
				<td align="right" bgcolor="#ffffff">￥<?php echo ($k['market_price']); ?>元</td>
			...
			<td colspan="7" class="f1 f14b" style="text-align:right;" bgcolor="#ffffff">
						购物金额小计 ￥<?php echo ($zj); ?>元，比市场价 ￥3612.00元 节省了 ￥602.00元 (17%)			</td>
			</tr>
	...
	<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
	    <tbody><tr>
		    <td align="right" bgcolor="#ffffff">
		      该订单完成后，您将获得<font class="f1 f4_b"><?php echo ($zj); ?></font> 积分，以及价值<font class="f1 f4_b">￥0.00元</font>的红包。
		    </td>
		  	</tr>
		    <tr>
		    <td align="right" bgcolor="#ffffff">
...
<div style="margin:8px auto;" align="center">
		<input src="/Home/images/bnt_subOrder.gif" type="image">
...
<div class="block tc" style=""> <img src="/Home/images/serviceImg1.jpg"> </div>
