...
<link href="/shopbe/Public/Home/css/style.css" rel="stylesheet" type="text/css">
...
<div class="block1">
    <div class="site-bar">
       ...
       <?php if(che()): ?>欢迎 <font color="red"> <?php echo (cookie('username')); ?> </font> 光临本店
           | <a href="<?php echo U('Home/user/logout');?>">退出</a>
           <?php else: ?>
           <a href="<?php echo U('Home/user/login');?>">登录</a>
           |
           <a href="<?php echo U('Home/user/reg');?>">免费注册</a><?php endif; ?>
...
<div class="page-header clearfix">
  <div class="block1 clearfix" style="position:relative;">
    <div class="logo fl"><a href="./index.php.htm" title=""><img src="/shopbe/Public/Home/images/logo.gif" width="311" height="55" alt=""></a></div>
    <div class="btMap">
      <div class="search ">
...
<div style="position:relative; width:1190px; margin:0 auto;"><object width="1190" height="360"><img src="/shopbe/Public/Home/images/banner.png" style='margin:0 0 0 250px;' alt="" />
</object>
...
<tbody><tr><td><a href="" target="_blank"><img src="/shopbe/Public/Home/images/1370400501175025752.jpg" width="230" height="100" border="0"></a></td></tr>
</tbody></table></div> </div>
	...
	<span class="lb"></span><span class="rb"></span>
	 <ul id="top10">
         <?php if(is_array($his)): foreach($his as $k=>$h): ?><li>
			 <div class="first">
			  <div class="fl">
				<font style="color:#F00; font-weight:bold"></font> <a href="#" title="">11111111111</a>
				</div>
				<div class="fr"><b class="f1">￥11111111111元</b></div>
			 </div>
			 <!-- <div class="last">
			  <a href=""><img src="/shopbe/Public/Home/images/3_thumb_G_1368081034405.jpg" alt="" align="left"></a>
...
<div class="mod1 mod2 blank brandboxs1">
	...
	<div class="brandsL clearfix">
		<a href=""><img src="/shopbe/Public/Home/images/1240803062307572427.gif" alt="诺基亚 (7)"></a>
    <a href=""><img src="/shopbe/Public/Home/images/1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
    <a href=""><img src="/shopbe/Public/Home/images/1240803144788047486.gif" alt="多普达 (1)"></a>
    <a href=""><img src="/shopbe/Public/Home/images/1240803247838195732.gif" alt="飞利浦 (1)"></a>
    <a href=""><img src="/shopbe/Public/Home/images/1240803352280856940.gif" alt="夏新 (1)"></a>
    <a href=""><img src="/shopbe/Public/Home/images/1240803412367015368.gif" alt="三星 (2)"></a>
    <a href=""><img src="/shopbe/Public/Home/images/1240803482283160654.gif" alt="索爱 (2)"></a>
	</div>
</div>
...
<div class="recommendContent entry-content" id="show_hot_area">
        <?php if(is_array($hot)): foreach($hot as $key=>$h): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$h['goods_id']));?>"><img src="/shop<?php echo ($h[goods_img]); ?>" alt="<?php echo ($h['goods_name']); ?>"></a></div>
              ...
              <font class="goodspice market">￥<?php echo ($h["market_price"]); ?>元</font>
			 			 <b class="f1">￥<?php echo ($h["shop_price"]); ?></b><br>
...
<div class="recommendContent entry-content" id="show_best_area">
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=5.htm"><img src="/shopbe/Public/Home/images/5_thumb_G_1370338478388.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
			 <a href="./goods.php-id=5.htm" title="ECSHOP模板中心68ecshop.com测试商品">ECSHOP模板中心68ecs...</a><br>
              <font class="goodspice market">￥24元</font>
			 			 <b class="f1">￥20元</b><br>
			</div>
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=7.htm"><img src="/shopbe/Public/Home/images/7_thumb_G_1370338401919.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
      ...
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=22.htm"><img src="/shopbe/Public/Home/images/22_thumb_G_1370338695095.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
      ...
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=19.htm"><img src="/shopbe/Public/Home/images/19_thumb_G_1370338674278.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
...
<div class="recommendContent entry-content" id="show_new_area">
      ...
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=3.htm"><img src="/shopbe/Public/Home/images/3_thumb_G_1368081034405.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
...
<div class="block tc" style=""> <img src="/shopbe/Public/Home/images/serviceImg1.jpg"> </div>
