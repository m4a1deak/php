      ...
      //mod_column/mod_column.php?lang=cn&pid=sregion20160923_1305203022&type=region&file=editcnt&pidname=colu20170914_1813504419';
        ...
        else
        {
         $linkv = $urlhere.'/mod_block/mod_block.php?lang='.LANG.'&act=edit&type='.$nodetype.'&pidname='.$pidname;
 		 ...
 		 echo  '<a style="display:none" target="_blank" href="'.$linkv.'" class="dmedit">'.$editv.'</a>';
...
function editlinkgoadm($v,$catepidname,$type){  //for node content...
global $curstyle;
    ...
    $urlhere = BASEURL.ADMINDIR;
	 ...
	 echo '<div class="dmeditnode">';
		    if($type=='node'){
				...
				$linkv = $urlhere.'/mod_category/mod_subcate.php?lang='.LANG.'&catid='.$catepidname;
				 echo  '<a class="cate" target="_blank" href="'.$linkv.'">编辑分类</a>';
