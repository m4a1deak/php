 ...
 <tr>
  ...
  <tr>
    ...
    <?php select_from_arr($arr_editor,$editor,'');?>
          ...
          <br /><span class="cgray">如果选择其他编辑器，需要下载相关文件，<a href="<?php echo admlink('http://www.demososo.com/editor.html')?>" target="_blank">具体请看教程></a></span>
 </td>
    </tr>
    ...
    <?php select_from_arr($arr_yn,$sta_frontedit,'');?>
      ...
      <a href="<?php echo admlink('http://www.demososo.com/detail-97.html')?>" target="_blank">什么是前台编辑</a>
   </td>
    </tr> 
      <tr>
      <td class="tr">样式缓存：</td>
