...
if ($act == 'update') {
  ...
  if ($abc1 == '')  { echo '请输入标题'; exit; }
    ...
    $ss = "update " . TABLE_ALBUM . " set title='$abc1',cssname='$abc2',effect='$abc3',cus_columns='$abc4'  where id='$tid'  $andlangbh limit 1"; 
        //echo $ss;exit;
        iquery($ss);  
   ...
   $ss = "insert into ".TABLE_ALBUM." (pid,pidname,type,pbh,lang,title,cssname,effect,cus_columns) values ('$pid','$pidnamecur','$type','$user2510','".LANG."','$abc1','$abc2','$abc3','$abc4')";  
      // echo $ss;exit;   
       iquery($ss);    
         jump($jumpv);
   }
