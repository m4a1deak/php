...
$arr_maincateV='shop_priceold:##hide==#==shop_price:##hide==#==shop_currency:##hide==#==shop_currencycn:##hide==#==shop_linktitle:##hide==#==formblockid:##==#==authorcate:##hide==#==authorcompanycate:##hide==#==authordatecate:##hide==#==authorhitcate:##hide==#==news_title:##==#==news_moretitle:##==#==sta_fontsize:##y==#==sta_sharebtn:##y==#==sta_tag:##y==#==nextprev:##nextprev.php==#==relativetitle:##相关文章==#==relativefg:##relative_grid.php';
...
$dmlink_home = admlink('http://www.demososo.com');
$dmlink_color = admlink('http://www.demososo.com/color.html'); //配色方案
$dmlink_more = admlink('http://www.demososo.com/detail-99.html'); //什么是更多的链接?
$dmlink_fontawesome = admlink('http://www.demososo.com/fontawesome.html'); //fontawesome
$dmlink_baidumap = admlink('http://www.demososo.com/baidumap.html'); //baidumap
$dmlink_frontedit = admlink('http://www.demososo.com/detail-97.html'); //什么是前台编辑
$dmlink_editor = admlink('http://www.demososo.com/editor.html'); //选择其他编辑器
$dmlink_install = admlink('http://www.demososo.com/install.html'); //请先观看视频教程>
?>
