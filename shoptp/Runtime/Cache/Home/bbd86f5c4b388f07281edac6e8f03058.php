            ...
            <div class="block box">
                ...
                <div class="usBox">
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="yw0" action="<?php echo U('Home/user/register');?>" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="password2" id="User_password2" type="password" /><span style="color:red;"><?php echo ($errorinfo['password2']); ?></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="user_email" id="User_user_email" type="text" value="" /> <span style="color:red;"><?php echo ($errorinfo['user_email']); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="user_qq" id="User_user_qq" type="text" value="" /><span style="color:red;"><?php echo ($errorinfo['user_qq']); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;"><?php echo ($errorinfo['user_xueli']); ?></span><div class="errorMessage" id="User_user_xueli_em_" style="display:none"></div>                            </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            </span>     <span style="color:red;"><?php echo ($errorinfo['user_hobby']); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
